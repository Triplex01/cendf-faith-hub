...
const prayers = [
  {
    id: 0,
    title: "Le Symbole de Nicée-Constantinople",
    category: "Profession de foi",
    text: `Je crois en un seul Dieu, le Père tout-puissant, créateur du ciel et de la terre, de l'univers visible et invisible.
