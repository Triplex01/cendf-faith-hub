...
// Images importées - cohérentes avec la page Actualités
...
// Articles statiques - synchronisés avec la page Actualités
const staticArticles = [
  ...
  },
  {
    ...
    excerpt: "Que cette nouvelle année soit remplie de la grâce divine et de la paix du Christ pour tous les fidèles.",
    image: voeux2026,
    date: "1 Janvier 2026",
    category: "Message",
  },
  {
    ...
    excerpt: "La Commission Épiscopale pour la Doctrine de la Foi a célébré avec ferveur la naissance du Christ.",
